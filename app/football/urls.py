...
urlpatterns = [
    path("fixtures/<int:gameweek>/", views.GameweekMatchView.as_view(), name="gameweek-fixtures"),
    path("fixtures/", views.ListMatchView.as_view(), name="fixtures"),
    ...
    path("fixtures/upcoming/", views.ListUpcomingMatchesView.as_view(), name="upcoming")
]
